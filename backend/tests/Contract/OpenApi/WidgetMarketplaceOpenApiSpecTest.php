...
final class WidgetMarketplaceOpenApiSpecTest extends TestCase
{
    ...
    public function openapi_spec_defines_widget_marketplace_schemas(): void
    {
        ...
        $this->assertStringContainsString('WidgetTemplate:', $this->specContents);
        $this->assertStringContainsString('WidgetTemplates:', $this->specContents);
        $this->assertStringContainsString('AssignWidgetTemplateRequest:', $this->specContents);
